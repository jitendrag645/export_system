<div class="labs index">
	...
	<tr>
		...
		<td><?php echo h($lab['Lab']['mobile']); ?>&nbsp;</td>
		<td><?php echo h($lab['Lab']['landline']); ?>&nbsp;</td>
		<td><?php echo h($lab['Lab']['address']); ?>&nbsp;</td>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $lab['Lab']['id']), array(), __('Are you sure you want to delete # %s?', $lab['Lab']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
