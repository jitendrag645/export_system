...
<?php echo $this->Form->create('UserEnquiry'); ?>
	<fieldset>
		<legend><?php echo __('Edit User Enquiry'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('UserEnquiry.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('UserEnquiry.id'))); ?></li>
